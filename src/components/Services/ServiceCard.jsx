...
export default function ServiceCard({title,para}) {
  return (
    <div className='flex flex-col justify-between items-center w-[350px] h-[400px] gap-4 bg-PrimaryBackground px-4 py-10 rounded-xl hover:scale-105 ease duration-300 hover:ring-4 ring-PrimaryColor cursor-pointer'>
